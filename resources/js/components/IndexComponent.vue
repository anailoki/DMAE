...
<div>
            ...
            <div class="container">
                <div class="row align-items-center ">
                    <div class="col-12 mb-5 text-center">
                        <h1 class="mb-5">I. Simposio Bilateral México-Alemania</h1>

                        <h2 class="mb-3 text-light">Uso de Plantas Mexicanas para el tratamiento de la DMAE</h2>
                    </div>

                    <div class="col-md-5 mt-5 pt-5">
                        <h1 class="mb-3">Degeneración Macular Asociada a la Edad</h1>
                    ...
                    <div class="col-md-6 ml-auto">
                        <div class="white-dots">
                            <img src="images/Nopal.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="container">
        <div class="row justify-content-center  mb-5">
          <div id="program" class="col-md-7 text-center">
            <h3 class="section-heading text-center">Programa del Seminario</h3>
    ...
    <div class="site-section section-3" data-stellar-background-ratio="0.5" style="background-image: url('images/sahuaro.jpg');">
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-7 text-center mb-5">
            <h2 class="text-white section-heading primary-color-icon text-center">Registrarme</h2>
            <p class="lead text-white mb-5">¡Anímate a esta gran oportunidad!</p>
            <p class="lead text-white mb-5">Empieza a conocer mas...</p>
            <p><a href="contact.html" class="btn btn-primary">¡Registrarme!</a></p>
          </div>
        </div>
      </div>
    </div>
