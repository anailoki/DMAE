        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
                ...
                <img src="images/klettner.JPEG" alt="Image"
                 class="img-fluid">
            
              <div class="post-entry-1-contents">
                <span class="meta">Profesor Investigador</span>
                <h2>Dr. Alexa Karina Klettner</h2>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
                ...
                <img src="images/iloki.JPEG" alt="Image"
                 class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
                ...
                <img src="images/lewis1.JPEG" alt="Image"
                 class="img-fluid">
            
              <div class="post-entry-1-contents">
                <span class="meta">Investigador</span>
                <h2>M.C. Lidianys Lewis Luján</h2>
